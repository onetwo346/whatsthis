            ...
            const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${this.geminiApiKey}`, {
                ...
                body: JSON.stringify({
                    contents: [{
                        parts: [
                            {
                                text: "Analyze this image and identify EVERYTHING visible - no matter what it is. This includes: animals (exact breed/species), products (brand + name), plants/trees (exact species), food (dish name/brand), buildings/architecture (style/type), furniture, appliances, materials (wood, metal, glass, fabric), natural elements (sky, clouds, water, landscapes), vehicles (make/model), electronics, clothing (type/brand), body parts (hands, legs, arms, feet, lap, knees, etc.), human features, artwork, text/signs, screens (what's showing), rooms/spaces, tools, toys, and literally ANYTHING else visible. If you see a person or body part, identify it specifically (e.g., 'Human Lap/Thighs', 'Person's Hand', 'Legs with Jeans', 'Clothed Torso'). If multiple objects are present, identify the most prominent one. Be extremely specific - use brand names, species names, architectural styles, material types, clothing descriptions, etc. If it's something abstract like 'a view through a window', describe what's visible (e.g., 'Window View - Residential Neighborhood' or 'Glass Window with Outdoor Landscape'). NEVER say you can't identify something - always provide your best analysis. Format as JSON: {name: 'specific name', category: 'category', icon: 'emoji', uses: 'uses', origin: 'origin/made by', description: 'detailed description', warning: 'warning or null', confidence: 'XX%'}. Examples: 'Wooden Double-Hung Window', 'Drywall Interior Wall', 'LED Ceiling Light Fixture', 'Human Lap with Denim Jeans', 'Person's Hand', 'Cotton T-Shirt', 'Suburban Street View', etc."
                            },
                            {
                                inline_data: {
